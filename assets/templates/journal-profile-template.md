<!-- Adapted from templates/journal-profile-template.md at be53c12f235996dff41fb7f21580506fd2dd8d50; source SHA-256 12055c2de22991e7f25244b14ba9afdcae4f7b6a702c9abd0abbf6d341c51b38. -->

# Journal Profile Template

Copy this block into `references/journal-profiles.md` (under the appropriate regional/field section) and fill in every field. Weights for the 6 dispositions must sum to 1.0.
...
For non-econ fields, add your own types to `references/agent-roles/methods-referee.md` by duplicating the rubric block and editing the dimension weights. Examples:
...
- `references/journal-profiles.md` — the live calibration file.
- `references/agent-roles/editor.md` — reads profiles, draws referee dispositions.
- `skills/review-paper/SKILL.md` — entry point for `--peer [SHORT]`.
