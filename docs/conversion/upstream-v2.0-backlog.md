<!-- Retained from C:/GitHub/claude-code-my-workflow/.claude/references/v2.0-backlog.md at be53c12f235996dff41fb7f21580506fd2dd8d50; source SHA-256 c249a197dc8b0574195c5296fa9f4b0fbc16c2f76b9f4dc14981dd7f4ac131af. -->
...
- ✅ **Capability skills** — none of `/syllabus`, `/teach-from-paper`, `/power-analysis`, `/replication-package`, `/respond-to-eval` shipped this cycle (these remain deferred — see below). However, **6 *new* skills** outside the original v1.9 capability list shipped: `/humanize`, `/prompt`, `/prompt-only`, `/compress-session`, `/promote-memory`, `/stata-replication`. See the [upstream v1.9.0 changelog](https://github.com/pedrohcgs/claude-code-my-workflow/blob/be53c12f235996dff41fb7f21580506fd2dd8d50/CHANGELOG.md) for full details.
...
The v2.0.0 "modernization" release (2026-06-09) shipped the loop-first / gate-enforced paradigm shift plus the long-deferred capability skills. See the [upstream v2.0.0 changelog](https://github.com/pedrohcgs/claude-code-my-workflow/blob/be53c12f235996dff41fb7f21580506fd2dd8d50/CHANGELOG.md).
