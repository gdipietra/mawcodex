<!-- Adapted from .claude/rules/did-conventions.md at be53c12f235996dff41fb7f21580506fd2dd8d50; source SHA-256 e58e9167f000dc2e04a4efa62059711a85581218fa9f6343a9fa48e3553766d5. -->

## Applicability

Load this rule for: `**/*did*.R`, `**/*did*.do`, `**/*event*study*.R`, `**/*att_gt*.R`, `**/*csdid*.do`, `**/*drdid*`, `scripts/**/*did*.qmd`.
...
## Cross-references
- [`skills/did-event-study/SKILL.md`](../../skills/did-event-study/SKILL.md) — the pipeline.
- [`references/rules/replication-protocol.md`](replication-protocol.md) · [`references/rules/r-code-conventions.md`](r-code-conventions.md) · [`references/rules/simulation-conventions.md`](simulation-conventions.md).
