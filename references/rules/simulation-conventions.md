<!-- Adapted from .claude/rules/simulation-conventions.md at be53c12f235996dff41fb7f21580506fd2dd8d50; source SHA-256 245f8b9eaa09b0ed48d1cd0d80f7637b92188a28dc50c9737fe1ea81c8832e31. -->

## Applicability

Load this rule for: `**/*simulation*.R`, `**/*_sim.R`, `**/*_mc.R`, `scripts/**/simulations/**`, `explorations/**/*.R`.
...
> **Scope:** This rule covers *simulation-specific* discipline. General R standards (header, `library()` at top, relative paths, figure theme, no float `==`, CDF clamping, pre-allocation) live in [`r-code-conventions.md`](r-code-conventions.md) and the [`r-reviewer`](../agent-roles/r-reviewer.md) Cat 9 (error handling) + Cat 11 (numerical discipline) checklists. Do not restate those here — follow both.
...
- [`../agents/sim-reviewer.md`](../agent-roles/sim-reviewer.md) — the agent that enforces this rule.
- [`../agents/r-reviewer.md`](../agent-roles/r-reviewer.md) — Cat 9 (error handling) + Cat 11 (numerical discipline).
