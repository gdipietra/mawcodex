<!-- Adapted from .claude/rules/stata-code-conventions.md at be53c12f235996dff41fb7f21580506fd2dd8d50; source SHA-256 7dfc07708e20cc7c9c48c77f660a118cb2fae3d2aa5590d9b99f92f1befee5d1. -->

## Applicability

Load this rule for: `**/*.do`, `scripts/stata/**`.
...
- [stata-mcp on GitHub](https://github.com/SepineTam/stata-mcp) — the MCP server that lets Codex execute Stata `.do` files. Install via `configure the `stata-mcp` server in the active Codex profile`.
