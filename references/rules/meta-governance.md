<!-- Adapted from .claude/rules/meta-governance.md at be53c12f235996dff41fb7f21580506fd2dd8d50; source SHA-256 ef89a0b17adb375ffb111837864302f5cf541cf46cbc88ddf3aaa7739a1d692a. -->
...
| Skills (generic) | ✅ Yes | skills/ | ✅ Yes |
| Rules (path-scoped, generic) | ✅ Yes | references/rules/ | ✅ Yes |
| Agents (generic) | ✅ Yes | .codex/agents/ | ✅ Yes |
| Hooks (generic behavior) | ✅ Yes | hooks/ | ✅ Yes |
| Session logs | ✅ Yes | quality_reports/session_logs/ | ✅ Yes |
| Plans | ✅ Yes | quality_reports/plans/ | ✅ Yes |
| Local settings | ❌ No | .codex/config.local.toml | ❌ No (gitignored) |
