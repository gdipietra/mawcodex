<!-- Adapted from .claude/rules/plan-first-workflow.md at be53c12f235996dff41fb7f21580506fd2dd8d50; source SHA-256 437e967768d44d4b676f1b4136964b66867be0a89e1252fb545fd0b340a00c6d. -->
...
1. **Establish a plan** — use Codex plan mode when the active surface exposes
   it; otherwise write the same explicit plan directly
...
**Protocol:**
1. Ask concise questions only for ambiguities that materially change the
   result (maximum 3-5 questions)
...
### General Principles
- Prefer Codex's automatic compaction over discarding the task context
- Save important context to disk before it's lost
- Start a fresh task only when the current context is genuinely polluted
