<!-- Adapted from .claude/rules/r-code-conventions.md at be53c12f235996dff41fb7f21580506fd2dd8d50; source SHA-256 d5a84060a58c2db6d36acdc14d3502ad0b52d89a938839cf767925daad8bc0d3. -->

## Applicability

Load this rule for: `Figures/**/*.R`, `scripts/**/*.R`, `explorations/**/*.R`.
...
See [`r-reviewer.md`](../agent-roles/r-reviewer.md) Category 11 ("Numerical Discipline") for the full checklist. Headline rules:
