<!-- Adapted from .claude/rules/summary-parity.md at be53c12f235996dff41fb7f21580506fd2dd8d50; source SHA-256 f77488e8ce6399de788e66420bdf7eb8ee548ec630cc9223a84acd2269d0bd38. -->

## Applicability

Load this rule for: `CHANGELOG.md`, `README.md`, `**/*.qmd`, `skills/*/SKILL.md`, `references/rules/*.md`, `.codex/agents/*.toml`.
...
| "Edits to `.codex/agents/X.toml` and `skills/Y/SKILL.md`" | "Existing infrastructure revised" |
...
- `skills/commit/SKILL.md` — when writing the commit message for a doc-heavy PR, apply this rule to the `## Summary` section before pushing.
- `skills/audit-reproducibility/SKILL.md` — "Repeated EXPLAINED is a signal (two-strikes)" reuses this pattern for contested numeric claims.
