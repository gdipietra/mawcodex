<!-- Adapted from .claude/rules/content-invariants.md at be53c12f235996dff41fb7f21580506fd2dd8d50; source SHA-256 375ad1d6c628ea004ca87a68ec1d3019f54af2ef493e3db68acc13337477bae6. -->

## Applicability

Load this rule for: `Slides/**/*.tex`, `Quarto/**/*.qmd`, `Quarto/**/*.scss`, `Preambles/header.tex`, `scripts/R/**/*.R`.
...
- **INV-6: No `\pause` or overlays.** Beamer `\pause`, `\only`, `\visible`, `\onslide` commands are forbidden. See `references/rules/no-pause-beamer.md` for rationale.
