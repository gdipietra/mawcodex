<!-- Adapted from .claude/agents/r-reviewer.md at be53c12f235996dff41fb7f21580506fd2dd8d50; source SHA-256 52ec6032439f2abfbdc67fd1cee6108def7add2beee39d2dba6990b6af7c7f10. -->
...
2. **Read `references/rules/r-code-conventions.md`** for the current standards
...
- [ ] Check `references/rules/r-code-conventions.md` for known pitfalls
...
5. **Check Known Pitfalls.** See `references/rules/r-code-conventions.md` for project-specific bugs.
