<!-- Adapted from .claude/agents/editor.md at be53c12f235996dff41fb7f21580506fd2dd8d50; source SHA-256 f8f1dd071358670055aa33c7bb0ba0a00d9b2115602d592f1f7b1fcf70bf3ba6. -->
...
Before doing anything, read `references/journal-profiles.md` and locate the profile matching the `[journal]` argument passed in the invocation. State in your first output line: `Calibrated to: [journal full name] (SHORT)`. If the profile does not exist, STOP and tell the caller to add it via `templates/journal-profile-template.md`.
...
Run **up to 3 web search probes** to verify the paper's novelty claim:
