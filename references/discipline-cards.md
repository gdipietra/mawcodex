<!-- Adapted from .claude/references/discipline-cards.md at be53c12f235996dff41fb7f21580506fd2dd8d50; source SHA-256 aa481377250ee97b2d4288263a1b73bea8930b1c0a789bc70969c36b434c7df1. -->
...
**Evidence boundary.** Shares, rankings, and field norms below are rough
calibration heuristics inherited from the fixed source snapshot. They are not
a measured current census. Verify live journal and registry policies from
official sources before making a consequential recommendation; otherwise mark
the relevant statement UNVERIFIED.
...
- **File:** `references/discipline-cards.md`
- **Schema parallel:** `references/journal-profiles.md` (per-journal) and `references/audit-pet-peeves.md` (living-catalogue format).
