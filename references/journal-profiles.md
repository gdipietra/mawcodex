<!-- Adapted from .claude/references/journal-profiles.md at be53c12f235996dff41fb7f21580506fd2dd8d50; source SHA-256 c6bc54136d4a4750f4278bef08a37fc39e57e03e082194428c727e2d1143dcb6. -->
...
**Currency boundary.** These profiles are review-calibration priors from the
fixed source snapshot, not current journal policy. Before relying on a
submission rule, formatting requirement, data policy, editor identity,
acceptance statistic, or deadline, verify the journal's current official
instructions. If that verification is unavailable, label the item UNVERIFIED
and do not present it as a live requirement.
...
- `references/agent-roles/editor.md` — reads this file.
- `references/agent-roles/domain-referee.md` — applies domain-referee adjustments.
- `references/agent-roles/methods-referee.md` — applies methods-referee adjustments.
- `skills/review-paper/SKILL.md` — `--peer [journal]` mode entry point.
